...
public class Rectangle extends Polygon
{
    ...
    public Rectangle(Point center, int width, int height, Color color, boolean filled)
    {
        ...
        int uno = height/2;
        int dos = width/2;
        location[0] = new Point(center.x - dos, center.y + uno);
        location[1] = new Point(center.x + dos, center.y + uno);
        location[2] = new Point(center.x + dos, center.y - uno);
        location[3] = new Point(center.x - dos, center.y - uno);
