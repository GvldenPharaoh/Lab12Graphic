...
public class Oval extends Shape
{
    ...
    public Oval(Point pointCenter, int diameter1, int diameter2, Color color, boolean filled)
    {
        ...
        location[1] = new Point(pointCenter.x - a, pointCenter.y + b);
        location[2] = new Point(pointCenter.x + a, pointCenter.y + b);
        location[3] = new Point(pointCenter.x + a, pointCenter.y + b);
        location[4] = new Point(pointCenter.x - a, pointCenter.y + b);
